...
public class GlideHelper {
    ...
    static RequestOptions options_head = new RequestOptions()
            .centerCrop()
            .placeholder(R.mipmap.icon_mine_head)
            .error(R.mipmap.icon_mine_head)
            .priority(Priority.HIGH)
            .diskCacheStrategy(DiskCacheStrategy.NONE);

    static RequestOptions options_context = new RequestOptions()
            .centerCrop()
            .placeholder(R.mipmap.icon_image_fail_round)
            .error(R.mipmap.icon_image_fail_round)
            .priority(Priority.HIGH)
            .diskCacheStrategy(DiskCacheStrategy.NONE);
    ...
    //默认加载头像
    public static void loadHeadImageView(Context mContext, Integer resourceId, ImageView mImageView){
        Glide.with(mContext).load(resourceId).apply(options_head).into(mImageView);
