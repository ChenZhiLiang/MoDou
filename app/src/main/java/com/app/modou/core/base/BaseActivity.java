...
import com.app.modou.ui.AppManager;
...
import com.app.modou.core.interfaces.BaseViewInterface;
...
//           //透明导航栏
    ...
    private void initHud() {
        ...
        hud = KProgressHUD.create(this)
                ...
                .setLabel(getString(R.string.loading),this.getResources().getColor(R.color.blue))
                .setAnimationSpeed(2)
                .setDimAmount(0.5f)
                .setCancellable(true);
    }
     ...
     * @param show
     */
    public void ShowOrHideSubmit(boolean show, String text, int color) {
        if (show) {
